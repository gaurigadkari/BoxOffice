...
* [x] Changed App icon and App name
* [x] Implemented ScrollView in details page
...
- [Okhttp3] (https://github.com/square/okhttp/tree/master/okhttp/src/main/java/okhttp3) - To make network calls
